...
export { installService, uninstallService } from "https://deno.land/x/service@1.0.0-alpha.4/mod.ts"
export type { InstallServiceOptions, UninstallServiceOptions } from "https://deno.land/x/service@1.0.0-alpha.4/mod.ts"
